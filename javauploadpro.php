...
<head>
    ...
    <title>Java project upload</title>
...
<?php
    ...
    ?>
		...
		<h1 class="text-center"><b>Upload Your Java Project</b></h1>
...
if(isset($_POST['submits']))
{
	...
	$query = "INSERT INTO jvproject(projectname,projectdiscription,jproject) values('$pname','$pdiscription','$folder')";
