    ...
    <div class="row">
       ...
       // include("download.php");
        ...
        if($total!=0)
        {
            ...
            <h2 class="text-center container" style="padding-bottom:30px;">Python Projects</h2>
        ...
        while($row=mysqli_fetch_assoc($query_run))
        {
            ...
            <td><a href='$row[pytproject]' class='btn btn-info'>Download</a></td>
            </tr>
             ";
