...
<?php
    ...
    ?>
		...
		<div class="col-lg-8 m-auto" style="padding-top:15px;">
			<form action="" method="post" enctype="multipart/form-data">
				...
				<input type="submit" name="submit" value="Upload" class="btn btn-success ml-3">
			</form>
		</div>
...
if(isset($_POST['submit']))
{
	...
	$query = "INSERT INTO clangproject(projectname,projectdiscription,cproject) values('$pname','$pdiscription','$folder')";
