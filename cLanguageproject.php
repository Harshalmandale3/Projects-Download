...
<div class ="container-file" >
    <div class="row">
      ...
      //  include("download.php");
        ...
        $query= "SELECT * FROM clangproject";
        ...
        if($total!=0)
        {
            ...
            <h2 class="text-center container" style="padding-bottom:30px;">C projects</h2>
        ...
        while($file=mysqli_fetch_assoc($query_run))
        {
            ...
            <td>".$file['projectdiscription']."</td>
            <td><a href='$file[cproject]' class='btn btn-info'>Download</a></td>
            </tr>
             ";
