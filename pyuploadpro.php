...
<head>
    ...
    <title>Python project upload</title>
...
<?php
    ...
    ?>
		...
		<h1 class="text-center"><b>Upload Your Python Project</b></h1>
...
if(isset($_POST['submits']))
{
	...
	$query = "INSERT INTO pyproject(projectname,projectdiscription,pytproject) values('$pname','$pdiscription','$folder')";
